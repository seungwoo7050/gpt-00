#!/usr/bin/env python3
"""
Test script for LogCaster-CPP MVP4 Persistence Features
"""
...
def start_server(with_persistence=True):
    """Start the LogCaster-CPP server"""
    cmd = ['./logcaster-cpp']
    if with_persistence:
...
def test_persistence():
    ...
    print("=== LogCaster-CPP MVP4 Persistence Test ===\n")
    ...
    try:
        ...
        with open(current_log, 'r') as f:
            content = f.read()
            if "你好世界" in content and "🌍" in content:
