...
def test_help_command():
    ...
    print(f"Response:\n{response}")
    return "LogCaster Query Interface - MVP3" in response
...
def run_tests():
    """Run all MVP3 tests"""
    print("LogCaster-C MVP3 Test Suite")
    print("============================")
...
if __name__ == "__main__":
    ...
    print("Make sure LogCaster-C server is running on ports 9999/9998")
