#!/usr/bin/env python3
"""
Test script for LogCaster-CPP MVP3 Enhanced Query Features
"""
...
def test_mvp3_features():
    ...
    print("=== LogCaster-CPP MVP3 Feature Test ===\n")
...
if __name__ == "__main__":
    try:
        ...
        print("Error: Could not connect to server. Make sure LogCaster-CPP is running.")
        sys.exit(1)
